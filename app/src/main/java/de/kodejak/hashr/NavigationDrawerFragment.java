...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDrawerListView = (ListView) linearLayout.findViewById(R.id.listview);
        ...
        for (int i=0; i < sections.length; i++) {
            if (sections[i].charAt(0) == '#') {
                mAdapter.addSectionHeaderItem(sections[i].substring(1,sections[i].length()));
            } else {
                mAdapter.addItem(sections[i].toString());
            }
        }
